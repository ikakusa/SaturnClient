...
namespace ImFX {
    ...
    bool AddShadow(float strength = 8.0f, ImVec4 color = ImVec4(0, 0, 0, 1), std::optional<ImVec4> clipRect = std::optional<ImVec4>(), std::optional<std::vector<ImVec4>> stencils = std::optional<std::vector<ImVec4>>());
